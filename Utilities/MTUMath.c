...
static vector_float3 MATH_FUNC_OVERLOAD vector_make(float x, float y, float z) {
...
static matrix_float3x3 MATH_FUNC_OVERLOAD matrix_make(float m00, float m10, float m20,
                                               float m01, float m11, float m21,
                                               float m02, float m12, float m22) {
    return (matrix_float3x3){ { { m00, m10, m20 }, { m01, m11, m21 }, { m02, m12, m22 } } };
}

static matrix_float4x4 MATH_FUNC_OVERLOAD matrix_make(float m00, float m10, float m20, float m30,
...
static matrix_float3x3 MATH_FUNC_OVERLOAD matrix_make(vector_float3 col0,
                                               vector_float3 col1,
                                               vector_float3 col2) {
...
matrix_float3x3 MATH_FUNC_OVERLOAD matrix3x3_scale(float sx, float sy, float sz) {
...
vector_float3 MATH_FUNC_OVERLOAD quaternion_rotate_vector(quaternion_float q, vector_float3 v) {
