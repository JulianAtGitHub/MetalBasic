...
- (void)initCommon {
    _renderer = [[RPRenderer alloc] init];
    ...
    __block RPViewController* weakSelf = self;
...
- (void)viewDidLoad {
    ...
    RPView *renderView = (RPView *)self.view;
    renderView.wantsLayer = YES;
    renderView.layer = _renderer.layer;
...
- (void)gameloop {
    ...
    [_delegate update:self.timeSinceLastDraw];
